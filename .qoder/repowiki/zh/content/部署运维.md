...
**更新** 项目已完成从阿里云ACR到GitHub Container Registry (ghcr.io)的全面迁移，新增完整自动化部署脚本套件，提供生产环境部署迁移的完整解决方案，包括一键部署、加密备份、安全恢复等功能。
...
subgraph "自动化脚本"
BOOT["bootstrap.sh<br/>一键部署"]
BACKUP["backup-secrets.sh<br/>加密备份"]
RESTORE["restore-secrets.sh<br/>安全恢复"]
END
UI --> |"HTTP/HTTPS"| API
API --> |"TCP 3306"| MYSQL
...
**更新** 项目已完全适配ghcr.io方案，提供更完善的自动化部署与运维能力，包括恢复脚本支持和完整的生产环境迁移解决方案。
