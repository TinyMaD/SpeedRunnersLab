...
- 优化构建可靠性：通过 --ignore-engines 参数绕过引擎版本检查，提升构建稳定性
- 更新构建系统：采用更简洁的构建流程，减少构建失败风险
...
- 部署故障排查与监控建议
- **新增**：构建系统整体优化：简化 Dockerfile 中的 registry 替换逻辑，提升构建可靠性
...
- 容器化与反向代理
  ...
  - **新增**：简化的构建流程，移除复杂的 registry 替换逻辑
- 构建脚本与预览
